...
const clientId =
  "BLEzg-1sTxGWpZW4ygaXl8AKvcp99FhI67AhE0lRWSwb43sIGJc1KTO2gdBAhxEmMrXXj9L48t18oY3Eu0YjolI"; // get from https://dashboard.web3auth.io
...
function Auth() {
  ...
  const [desoModalOpen, setDesoOpenModal] = useState(false);


  const closeDesoModal = () => {
    setDesoOpenModal(false);
  }
      ...
      try {
        ...
        const web3auth = new Web3Auth({
          ...
          uiConfig: {
            ...
            appLogo: "../../assets/S.png      ", // Your App Logo Here
          }
        });
        ...
        const openloginAdapter = new OpenloginAdapter({
          ...
          adapterSettings: {
            whiteLabel: {
              name: "Spatium Stories",
              logoLight: "../../assets/S.png",
              logoDark: "../../assets/S.png",
              defaultLanguage: "en",
  ...
  const getDesoAccount = async () => {
    ...
    console.log(jwt);
    const desoAddress = await deso.ethereum.ethAddressToDeSoPublicKey(address).catch(e => console.log(e));
    uiConsole("DESO Address: " + desoAddress);
  }
  ...
  const loggedInView = (
    <>
      <div className="flex-container">
        ...
        <div>
          <button onClick={getDesoAccount} className="card">
            Get DESO Account
          </button>
        </div>
        <div>
  ...
  return (
    <div className="container">
      ...
      <InformationModal title={"Do you have a Deso account?"} open={desoModalOpen} handleClose={closeDesoModal}>
            <p>Do you have a Deso account? If not, you can create one now or we can make one for you!</p>
        </InformationModal>
    </div>
  );
}
