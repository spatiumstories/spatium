...
const Book = (props) => {
    ...
    const onMoreDetailsHandler = () => {
        let url = `/marketplace/${props.bookData.postHashHex}`;
        navigate(url, {
            state: {
                onBuy: props.onBuy,
                    ...
                    <React.Fragment>
                        ...
                        {marketplace && props.bookData.price > 0 ? (
                            <CardActions>
                                ...
                                {props.bookData.cover.length === 1 && <Button onClick={onMoreDetailsHandler} size="large">More Details</Button>}
                            </CardActions>
                        ) : marketplace ? (
                            <CardActions>
